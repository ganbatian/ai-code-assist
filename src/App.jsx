...
import { Code2, Send, Loader2, Copy, Check, Terminal, Sparkles, MessageSquare, Bug, RefreshCw, BookOpen } from 'lucide-react'
...
const quickActions = [
  ...
  { icon: RefreshCw, label: '代码重构', desc: '优化代码结构' },
...
function App() {
  ...
  const loadExample = () => setCode(codeExamples[language])
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 overflow-hidden">
            <div className="flex items-center justify-between p-4 border-b border-white/10">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={loadExample} className="px-3 py-1 bg-white/10 rounded-lg text-sm hover:bg-white/20">示例</button>
              </div>
            </div>
            <textarea
              value={code}
              ...
              placeholder="粘贴或输入代码..."
              className="w-full h-80 p-4 bg-transparent resize-none outline-none text-sm leading-relaxed font-mono"
            />
